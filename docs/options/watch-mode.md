...
Подробнее о том, почему вместо режима заглушек рекомендуется watch, — в разделе [Почему tsdown не поддерживает режим заглушек (stub-mode)](../guide/faq.md#stub-mode).
