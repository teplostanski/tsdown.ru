...
После установки укажите браузер в окружении сборки (например, `target: 'chrome100'`) в конфиге или в CLI — адаптация CSS включится автоматически.
