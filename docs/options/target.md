...
Подробную информацию о понижении синтаксиса CSS, минификации и параметрах Lightning CSS см. в [документации по CSS](/options/css.md#целевое-окружение-для-css).
