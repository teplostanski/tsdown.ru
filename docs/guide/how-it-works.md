...
| Опция                                                                                 | Назначение                                                                                                                                                                |
| ------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [`deps.onlyBundle`](../options/dependencies.md#deps-onlybundle)                       | Список зависимостей, которые разрешено включать в бандл. Любая другая зависимость в бандле приведёт к ошибке. Помогает отловить случайное встраивание в больших проектах. |
| [`deps.neverBundle`](../options/dependencies.md#deps-neverbundle)                     | Дополнительные пакеты, которые всегда остаются внешними и не попадают в бандл.                                                                                            |
| [`deps.alwaysBundle`](../options/dependencies.md#deps-alwaysbundle)                   | Принудительно включает в бандл указанные пакеты, даже если они в `dependencies`.                                                                                          |
| [`deps.skipNodeModulesBundle`](../options/dependencies.md#deps-skipnodemodulesbundle) | Не включает в бандл зависимости из `node_modules`.                                                                                                                        |
