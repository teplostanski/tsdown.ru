...
| [`exports.all`](../options/package-exports.md#экспорт-всех-файлов)            | Экспортировать все выходные файлы, не только точки входа.                      |
...
| [`exports.customExports`](../options/package-exports.md#настройка-экспортов)  | Функция для изменения или дополнения сгенерированных экспортов.                |
