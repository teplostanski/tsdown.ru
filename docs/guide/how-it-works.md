...
## Умные значения по умолчанию {#умные-значения-по-умолчанию}
...
| [`deps.skipNodeModulesBundle`](../options/dependencies.md#deps-skipnodemodulesbundle) | Не разрешать и не бандлить ничего из `node_modules`.                                                                                                                      |
...
## Файлы деклараций (dts) {#файлы-деклараций}
...
## Экспорты пакета {#экспорты-пакета}
...
| [`exports.all`](../options/package-exports.md#экспорт-всех-фаилов)            | Экспортировать все выходные файлы, не только точки входа.                      |
| [`exports.devExports`](../options/package-exports.md#экспорты-для-разработки) | В разработке указывать экспорты на исходники для лучшей поддержки в редакторе. |
| [`exports.customExports`](../options/package-exports.md#настроика-экспортов)  | Функция для изменения или дополнения сгенерированных экспортов.                |

Подробнее: [Экспорты пакета](../options/package-exports.md).

## Валидация пакета {#валидация-пакета}
...
| [`attw`](../options/lint.md#attw)       | Включить: `true` или объект с `profile`, `level`, `ignoreRules`. |

Подробнее: [Валидация пакета](../options/lint.md).

## Остальные значения по умолчанию {#остальные-значения-по-умолчанию}
