...
const users = computed(() => {
  ...
  return [
...

    {
      ...
      logo: 'i-logos:vue',
      url: 'https://vuejs.org',
      class: 'logo-text-3xl logo-scale-120',
    },
    {
      name: 'Nuxt',
    ...
    },
    {
      ...
      class: 'logo-text-3xl logo-scale-130',
    },
    {
      name: 'Prettier',
      ...
      <div class="marquee-content">
        ...
        >
          <img
            ...
            :src="user.logo"
            :alt="user.name"
            :class="user.class || 'logo-h6'"
          />
          <div v-else :class="[user.logo, user.class || 'logo-text-3xl']" />
        </a>
      </div>
    </Marquee>
  </div>
